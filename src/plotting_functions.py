...
def make_animation_2d(x_vec, y_vec, Tout, geometry = 'cylindrical'):
    ...
    plot1=[ax1.contourf(x_mesh, y_mesh, Tout[0,:,:].T)]
...
def make_animation_2d_old(x_vec, y_vec, Tout, geometry = 'cylindrical'):
...
# # stuff below doesn't really work
